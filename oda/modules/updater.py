...
from oda import app
from oda.config import OWNER_ID, UPSTREAM_REPO, UPSTREAM_BRANCH, UPDATE
from oda.modules import runcmd, get_text, HEROKU_URL
...
async def update_it(client, message):
    ...
    try:
        ...
        return await msg_.edit(
            "**Invalid Git Command. Please Report This Bug To [UserLazy](https://t.me/RxyMX)**"
        )
